 ...
 * the following properties:
     ...
     * 3. Every block begins with a LABEL:
         ...
         * 6. Every block ends with a JUMP of CJUMP
 ...
 * "exit" label, produce a list of statements such that:
     * 1. and 2. as abovee
     * 7. Every CJUMP (_, t, f) is immediately followed by LABEL f.
     The blocks are reordered to satisfy property 7, also in this
     reordering as many JUMP(T.NAME(lab)) statements as possible
     are eliminated by falling through into T.LABEL(lab)
*)
